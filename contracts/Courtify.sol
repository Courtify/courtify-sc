...
contract Courtify is CourtifyRights {
     ...
     * 
     */
    event CaseCreated(address _initiator, uint256 indexed _caseID, uint256 _timestamp, string _state, string _district, string _court, uint256 indexed _petitonerID, uint256 indexed _caseType);
     ...
     * 
     */
    function createNewCase(uint256 _timestamp, string memory _state, string memory _district, string memory _court, uint256 _petitonerID, string memory _name, uint256 _caseType) public onlyCourt {
     ...
     * 
     */
    function _createNewCase(uint256 _timestamp, string memory _state, string memory _district, string memory _court, uint256 _petitonerID, string memory _name, uint256 _caseType) internal {
     ...
     * 
     */
    function getCase(uint256 _caseID) public view returns(uint256 _timestamp, string memory _state, string memory _district, string memory _court, string memory name, uint256 _caseType){
